...
public class ListOfCollectionsAdapter extends RecyclerView.Adapter<ListOfCollectionsAdapter.CollectionsViewHolder> {

    private CollectionListPresenter presenter;

    public ListOfCollectionsAdapter(CollectionListPresenter presenter) {
...
//        return presenter.getListCount();
    ...
    public class CollectionsViewHolder extends RecyclerView.ViewHolder implements CollectionItemView {
